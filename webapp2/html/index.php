...
<body><img class="Main-logo" src="img/horizoneevents.png" alt="Horizon Events">
<div class="navbar">
...
<div class="weather-cards">
    <div class="weather-card">
        <h2 id="city-1"></h2>
        <img id="icon-1" src="img/son.png" alt="Weather icon">
        <p id="temp-1"></p>
        <p id="condition-1"></p>
    </div>
    <div class="weather-card">
        <h2 id="city-2"></h2>
        <img id="icon-2" src="img/son.png" alt="Weather icon">
        <p id="temp-2"></p>
        <p id="condition-2"></p>
    </div>
    <div class="weather-card">
        <h2 id="city-3"></h2>
        <img id="icon-3" src="img/son.png" alt="Weather icon">
        <p id="temp-3"></p>
        <p id="condition-3"></p>
    </div>
</div>
...
<script>
    ...
    const weatherIcons = ["img/son.png", "img/son.png", "img/son.png", "img/son.png"];
