...
<div class="table-wrapper">
    ...
    <table class="fl-table">
        ...
        while($product = $stmt->fetch()) {
         echo "<tr>";
         echo "<td class='h2'>". htmlspecialchars($product['firstname']). "</td>";
         echo "<td class='h2'>". htmlspecialchars($product['username']). "</td>";
         echo "<td class='h2'>". htmlspecialchars($product['lastname']). "</td>";
         echo "<td>";
        echo "<a class='h2-link' href='updatepassword.php?username=". urlencode($product['username']). "'>Click here to edit user password</a>";
        echo "</td>";
        echo "</tr>";
}
?>
